...
<div class="row">
    ...
    <div class="col-sm-6 col-md-3">
      <div class="thumbnail">
          <a href="<?= Url::to(['user/view', 'id'=>$user->id]) ?>"><img class="thumbnail" src="<?= CommonUtil::cropImgLink(User::getInfo($user->id)->avatar,250,250) ?>" alt="<?= User::getInfo($user->id)->nickname ?>"></a>
        <div class="caption">
