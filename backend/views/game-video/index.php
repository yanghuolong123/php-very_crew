        ...
        'columns' => [
            ...
            [
                ...
                'value' => function($data){
                    ...
                    $return = Html::a(Html::img(CommonUtil::cropImgLink($video->logo, 240,150,1,false),['class'=>'thumbnail']),Yii::$app->params['frontendHost'].'video/view?from=backend&id='.$video->id, ['target'=>'_blank']);
                    $return .= "<p>作品名称：".Html::a($video->title,Yii::$app->params['frontendHost'].'video/view?from=backend&id='.$video->id, ['target'=>'_blank'])."</p>";
