        ...
        'columns' => [
            ...
            [
                ...
                'value' => function($data){
                    ...
                    $return = Html::a(Html::img(CommonUtil::cropImgLink($video->logo, 240,150,1,false),['class'=>'thumbnail']),Yii::$app->params['frontendHost'].'video/view?id='.$video->id, ['target'=>'_blank']);
