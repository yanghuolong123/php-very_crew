...
//            'username',
            [
                ...
                'format' => 'raw',
                'value' => function($data) {
                    return Html::a($data->username,Yii::$app->params['frontendHost'].'/index.php?r=user/view&id='.$data->user_id, ['target'=>'_blank']);// Html::a($data->username,['user/view', 'id' => $data->user_id]);
                },
            ],
            'amount',
            'summary',
