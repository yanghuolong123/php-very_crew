...
class ForumThreadSearch extends ForumThread
{
    ...
    {
        return [
            [['id', 'fid', 'user_id', 'views', 'posts', 'recommand', 'status', 'lastpost', 'createtime', 'updatetime'], 'integer'],
            [['title', 'content', 'lastposter'], 'safe'],
        ];
    }
    ...
    public function search($params)
    {
        ...
        $query->andFilterWhere(['like', 'title', $this->title])
            ...
            ->andFilterWhere(['like', 'lastposter', $this->lastposter]);
